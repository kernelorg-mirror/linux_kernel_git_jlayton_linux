...
#
%define package_conflicts initscripts < 7.23, udev < 063-6, ipw2200-firmware < 2.4, selinux-policy-targeted < 1.25.3-14, device-mapper-multipath < 0.4.9-64, dracut < 004-303.0.3
