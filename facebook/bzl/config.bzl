...
def config_name(arch, flavor = None, selftests = False, replace_arch = True):
...
def _impl(ctx: AnalysisContext) -> list[Provider]:
    ...
    selftests_config = _selftests_config(ctx)
...
_attrs = {
    ...
    "selftests": attrs.bool(default=False),
